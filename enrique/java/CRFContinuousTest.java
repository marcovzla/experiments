...
public class CRFContinuousTest{
	public CRFContinuousTest(String trainingFilename, String testingFilename) throws IOException {
...
// 			pipes.add(new TokenTextCharSuffix("slot_entropy=", 14));
...
// 			pipes.add(new TokenTextCharSuffix("slot_stdev=", 4));
		...
		public static void main (String[] args) throws Exception {
			CRFContinuousTest trainer = new CRFContinuousTest(args[0], args[1]);
